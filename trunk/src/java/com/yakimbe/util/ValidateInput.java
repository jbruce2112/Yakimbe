...
public final class ValidateInput {
    ...
    //TODO: ValidateUserName() should call this
    public static boolean isUserNameUnique(final String userName, final Connection conn) throws SQLException {
        final String query = "SELECT user_name FROM user WHERE user_name = ?";
        final PreparedStatement ps = conn.prepareCall(query);
        ps.setString(1,userName);
        
        final ResultSet rs = ps.executeQuery();

        final boolean isUnique = !rs.next();
